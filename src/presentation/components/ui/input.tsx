  ...
  ({ className, ...props }, ref) => (
    <input
      ...
      className={cn(
        ...
        'h-10 w-full min-w-0 rounded-(--radius-field) border border-border-field bg-surface px-3 text-base text-foreground placeholder:text-faint shadow-[inset_0_1px_2px_rgb(34_28_17_/_0.04)] sm:text-sm',
...
>(({ className, ...props }, ref) => (
  <textarea
    ref={ref}
    className={cn(
      'min-h-24 w-full min-w-0 rounded-(--radius-field) border border-border-field bg-surface px-3 py-2 text-base text-foreground placeholder:text-faint sm:text-sm',
      'transition-colors duration-150 hover:border-ink-400 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/25',
      'disabled:cursor-not-allowed disabled:opacity-50',
      className,
    )}
...
>(({ className, children, ...props }, ref) => (
  <select
    ref={ref}
    className={cn(
      'h-10 w-full min-w-0 appearance-none rounded-(--radius-field) border border-border-field bg-surface px-3 pr-8 text-base text-foreground sm:text-sm',
